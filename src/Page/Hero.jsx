  ...
  return (
    ...
    >
      <div className="w-full 2xl:h-[793px] xl:h-[743px] lg:h-[580px] md:h-[500px] sm:h-[700px] h-[750px] font-poppins bg-[#1090CB10] 2xl:pt-[137px] xl:pt-[128px] lg:pt-[110px] md:pt-[100px] sm:pt-[170px] pt-[490px] ">
        ...
        <p className="2xl:text-[43px] xl:text-[40px] lg:text-[32px] md:text-[28px] sm:text-[24px] text-[18px] font-bold 2xl:ml-[131px] xl:ml-[123px] lg:ml-[85px] md:ml-[65px] sm:ml-[45px] ml-[25px] 2xl:mt-[-426px] xl:mt-[-399px] lg:mt-[-250px] md:mt-[-200px] sm:mt-[100px] mt-[00px] 2xl:w-[672px] xl:w-[630px] lg:w-[470px] md:w-[390px] sm:w-auto 2xl:h-[206px] xl:h-[193px] lg:h-[150px] md:h-[160px] sm:h-[80px] h-[80px] md:text-left text-center md:justify-start sm:justify-center justify-center">
        ...
        <div>
          <img
            className="max-w-[597px] 2xl:w-[40vw] xl:w-[45vw] lg:w-[35vw] md:w-[40vw] sm:w-[50vw] w-[320px] h-auto 2xl:mt-[-694px] xl:mt-[-650px] lg:mt-[-450px] md:mt-[-450px] sm:mt-[-700px] mt-[-690px] 2xl:ml-[831px] xl:ml-[708px] lg:ml-[600px] md:ml-[450px] mx-auto"
            src={man}
            alt="man"
          />
          <img
      ...
      <div className="w-full bg-white py-8 px-4 lg:px-auto ">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:ml[0px] sm:ml-[100px] ml-[60px] gap-4  max-w-7xl mx-auto">
          <ServiceItem
            icon={list1}
