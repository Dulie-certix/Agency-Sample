        ...
        <div className="w-full 2xl:pt-[93px] xl:pt-[87px] lg:pt-[65px] md:pt-[55px] sm:pt-[45px] pt-[35px] sm:pl-[80px] pr-[80px]">
          <div className="grid grid-cols-1 md:grid-cols-3 xl:gap-53 mb-8 px-4">
            <div>
              ...
              <p className="2xl:text-[17px] xl:text-[16px] lg:text-[14px] md:text-[13px] sm:text-[12px] text-[11px] font-[400] text-[#515151]">
                @Lorem
              </p>
            </div>
            ...
            <div>
              ...
              <div className="2xl:text-[17px] xl:text-[16px] lg:text-[14px] md:text-[13px] sm:text-[12px] text-[11px] mt-[-10px] font-[400] text-[#515151] leading-[186%] space-y-2">
                <p>Lorem</p>
                <p className="mt-[-10px]">Portfolio</p>
                <p className="mt-[-10px]">Careers</p>
